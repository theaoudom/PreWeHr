...
fun LeaveRequest(navController: NavHostController) {
    ...
    Column(
        ...
        Row(
            ...
            IconButton(onClick = { navController.navigate(Screen.Leave.route)}) {
        ...
        // leave type
         Text(text = "Leave Type  (12.5)", fontWeight = FontWeight.Medium, fontSize = 16.sp)
        CustomButton(text = "Annual leave", contentColor = colorResource(id = R.color.leave_detail_text_color) , onClick = { /*TODO*/ })
        // Start date section
        ...
        // Apply button
       CustomButton(text = "Apply Leave", onClick = { navController.navigate(ScreenLeave.ScreenLeaveDetailRoute.route) }, modifier = Modifier.fillMaxWidth())
    }
}